...
for root, dirs, files in os.walk ("."):
    for Grand_File_TXT in files:
        if ".txt" in Grand_File_TXT: # 68.txt
            ...
            Grand_Age2 = str (int (Grand_Age1) + 5) # 73
...
for root, dirs, files in os.walk ("."):
    for Grand_File_DAT in files:
        if ".dat" in Grand_File_DAT: # 68.dat
            ...
            Grand_Age_2 = str (int (Grand_Age_1) + 5) # 73
            ...
            new_age = inp_age2 - 0.5                                            # 6.8 # Add a new column    # new_age = df [len (df.columns)]      # '{0:.1f}'.format (inp_age2 - 0.2) # new_age.round (1),
            ...
            df_all = pd.concat ([new_age.round (1), inp_age2.round (1), inp_age1, inp_age0, inp_age_3, inp_age_44.round (1), inp_age4.round (1), inp_age3], axis=1)   # 7.0 7.5 06 90 16 6.8 7.1 20
            ...
            for f_x in range (0, 100, 10):
                for SN in range (50, 110, 10):
                    ...
                    if f_x == 0:
                        ...
                        # Fill these columns with the same values for age1 since they are not applicable here (to maintain shape of the data file)
...
# StepSize5_00_Stat.txt ==> 6.8 7.0 0 50 7.0 0.05 7.0 6.9 0.2 7.6 1.1 8.7 6.5 0.6 53 2881.7 25.0 53.3 18 30 18 30 0 0
df_Grand_00_Stat.to_csv ("StepSize5_00_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_10_Stat.to_csv ("StepSize5_10_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_20_Stat.to_csv ("StepSize5_20_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_30_Stat.to_csv ("StepSize5_30_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_40_Stat.to_csv ("StepSize5_40_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_50_Stat.to_csv ("StepSize5_50_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_60_Stat.to_csv ("StepSize5_60_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_70_Stat.to_csv ("StepSize5_70_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_80_Stat.to_csv ("StepSize5_80_Stat.txt", header = None, index = None, sep = " ", mode = "w")
df_Grand_90_Stat.to_csv ("StepSize5_90_Stat.txt", header = None, index = None, sep = " ", mode = "w")

################################################################################
######################## Add columns to clean data file ########################

for root, dirs, files in os.walk ("."):
    for StepSize5_Stat_Files in files:
        if "StepSize5_" in StepSize5_Stat_Files: # StepSize5_00_Stat.txt
            StepSize5_Stat_Files_Name = StepSize5_Stat_Files.split (".") # StepSize5_00_Stat.txt
            StepSize5_Stat_First = StepSize5_Stat_Files_Name [0] # StepSize5_00_Stat

            df_SN_Stat = pd.read_csv (StepSize5_Stat_Files, engine = 'python', header = None, delim_whitespace = True)
            ...
            df_SN_Stat.to_csv (StepSize5_Stat_Files, sep = " ", header = None, index = None, mode = "w")

            #clean_file_name = str (Grand_Age1) + "_Clean.txt" ### StepSize5_00_Stat_Clean.txt
            #df_SN.to_csv (clean_file_name, header = None, index = None, sep = " ", mode = "w") ### StepSize5_00_Stat_Clean.txt
# 68_Stat.txt ==> 6.8 7.0 0 50 7.0 0.05 7.0 6.9 0.2 7.6 1.10 8.7 6.5 0.6 53 288 1.7 25.0 53.3 18 30 18 30 0 0 -- 25 columns --
